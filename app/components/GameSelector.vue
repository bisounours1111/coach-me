  ...
  <div class="space-y-3">
    ...
    >
      ...
      <div class="grid gap-3 sm:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)]">
        ...
        <div class="space-y-1.5">
          <label class="text-xs font-medium text-slate-200/90">Rang (facultatif)</label>
          <input
    ...
    <button
      ...
      @click="add"
    >
      <span class="h-4 w-4 rounded-full bg-[#6366f1]/15 text-center text-[0.7rem] leading-4 text-[#6366f1]">
        +
      </span>
      Ajouter un jeu
    </button>
