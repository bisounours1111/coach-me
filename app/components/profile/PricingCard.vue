...
<template>
  ...
  >
    <!-- Premium Glow Effect -->
    <div
      class="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-teal-500/10 blur-3xl transition-opacity duration-500 group-hover:opacity-100"
    />
    ...
    <div class="relative flex flex-1 flex-col p-8">
      ...
      <div class="flex items-start justify-between">
        <div class="space-y-1">
          ...
          <div
            v-else
            class="text-xl font-black text-slate-400 uppercase tracking-tight"
          >
            Sur mesure
          </div>
          <p
            class="text-[10px] font-black uppercase tracking-[0.2em] text-teal-500/80"
          >
      ...
      <!-- Divider -->
      <div
        class="my-6 h-px w-full bg-gradient-to-r from-white/10 via-white/5 to-transparent"
      />
      ...
      <div class="flex-1 space-y-4">
        ...
        <ul v-else-if="features.length" class="space-y-3">
          ...
          >
            <div
              class="mt-1 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-teal-500/20 text-teal-400"
            >
